...
public class TestB1BasicActivityX062 extends ViewTest {
    ...
    public void check_01_RadioGroupChange() { //Check Layout Specification
        RadioGroup unitType = activity.findViewById(R.id.radioGroup);
        ElementTest oriComp = new ElementTest(activity.findViewById(R.id.oriList));
        ElementTest convComp = new ElementTest(activity.findViewById(R.id.convList));
        ElementTest imgComp = new ElementTest(activity.findViewById(R.id.img));

        EditText inputText = activity.findViewById(R.id.inputText);
        EditText outputText = activity.findViewById(R.id.outputText);
