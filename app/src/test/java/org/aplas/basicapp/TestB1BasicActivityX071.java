...
public class TestB1BasicActivityX071 extends ViewTest {
    ...
    private void startActivity() throws NullPointerException, ClassCastException {
        ...
        unitType = activity.findViewById(R.id.radioGroup);
        ori = activity.findViewById(R.id.oriList);
        conv = activity.findViewById(R.id.convList);
        inText = activity.findViewById(R.id.inputText);
        outText = activity.findViewById(R.id.outputText);
